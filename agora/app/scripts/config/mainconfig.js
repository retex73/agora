var Mapper = {
    ...
    map: {
        ...
        'POS1': {
            'local': 'RoyalColleges_pub/POS1',
            'dev': 'RoyalColleges_pub/POS1',
            'test': 'RoyalColleges/POS1',
            'prod': 'RoyalColleges_prod/POS1'
        },

        'POS2': {
            'local': 'RoyalColleges_pub/POS2',
            'dev': 'RoyalColleges_pub/POS2',
            'test': 'RoyalColleges_pub/POS2',
            'prod': 'RoyalColleges_pub/POS2'
        },
        'POS3': {
            'local': 'RoyalColleges_pub/POS3',
            'dev': 'RoyalColleges_pub/POS3',
            'test': 'RoyalColleges_pub/POS3',
            'prod': 'RoyalColleges_pub/POS3'
        },
        'POU1': {
            'local': 'RoyalColleges_pub/POU1',
            'dev': 'RoyalColleges_pub/POU1',
            'test': 'RoyalColleges_pub/POU1',
            'prod': 'RoyalColleges_pub/POU1'
        },
...
var pagesObj = {
    ...
    repGroup: [{
            ...
            description: "The register contains information about all doctors who are registered with the GMC.<br/><br/>" + "You can explore who doctors on the register are by gender, age bands, ethnicity, nationality and country of medical qualification. " + "You can view how many doctors are on the GP or specialist register, as well as their area of specialty. You can also view how many doctors " + "in training there are in each specialty, and what stage of training they are at.",
            colour: '#2a3f61',
            image: 'reports-0.jpg',
            ...
            description: "Every five years each doctor is required to demonstrate they are fit to practise and that their knowledge and skills are up to date." + "This helps to ensure that all doctors in the UK are giving patients a good standard of care.<br/><br/>" + "This section contains data about how many doctors have revalidated. As the revalidation process continues this data will become more complete untill all doctors " + "practising in the UK have revalidated at least once.",
            colour: '#2ca7bf',
            image: 'reports-1.jpg',
            pages: {
                'Stats': [{
            ...
            description: "This section contains data about our fitness to practise processes, for occasions when doctors' performance falls below the expected standard." + "You can explore data on how many complaints lead to investigation and how many investigations lead to sanctions against doctors. " + " You can see what sort of allegations we receive, and data about the doctors who end up in our fitness to practise process.",
            image: 'reports-2.jpg',
            colour: '#5a2a80',
            pages: {
                'Stats': [{
            ...
            groupName: 'Employers',
            description: "Doctors in the UK are employed in a wide range of different environments. " + "From large hospitals to GP clinics to other organisations, the profession is diverse and ever evolving. " + "We work with all kinds of employers to ensure patients receive the best possible care and that doctors can practise successfully.<br/><br/>" + "This section contains data about organisations who employ the doctors on our register." + "It aims to show the population of doctors that work in an organisation, the geographic spread of doctors across the UK, and some of the outcomes " + "for doctors working in these locations.",
            image: 'reports-3.jpg',
            colour: '#b05898',
            pages: {
                'Stats': [{
            ...
            description: "This section contains data about doctors who have registered with us from UK medical schools.<br/><br/>" + "You can explore different cohort groups by year of graduation, gender, age bands, ethnicity and nationality. " + "You can also view data on doctors in training, their training specialty and level. " + "And you can see what specialties doctors have completed training in and what their current roles are.",
            image: 'reports-4.jpg',
            colour: '#7c418c',
            pages: {
                'Stats': [{
        ...
        {
            groupName: 'Deaneries',
            description: "We assure the quality of doctors' training and that involves us working with Postgraduate Deaneries and Local Eduction and Training Boards (LETBs), " + "who are responsible for training doctors across the UK.<br/><br/>" + "This section contains data about these bodies and doctors in postgraduate training who fall under them, " + "the programmes they are training in and outcomes from different cohort groups.",
            image: 'reports-6.jpg',
            colour: '#4275b3',
            pages: {
                'Stats': [{
